...
import Auto_non_malicious_message from '../../../components/05 AI_Action_Selection/AUTO/Auto_non_malicious_message';
...
/**
 * Auto Non Malicious Page
 * 
 * This page handles the automatic action for a non-malicious URL.
 * It displays the decision to automatically handle a URL that has been identified as safe.
 * 
 * @returns {JSX.Element} Auto non malicious page component
 */
function Auto_Non_Malicious() {
  ...
  const handleAutoComplete = () => {
    // When auto progress completes, hide auto message and show allowing progress
...
export default Auto_Non_Malicious;
