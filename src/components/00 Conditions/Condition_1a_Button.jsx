...
/**
 * Condition 1a Button Component
 * 
 * This component displays a button for condition 1a with a hover tooltip.
 * 
 * @param {Object} props - Component props
 * @param {Function} props.onClick - Click handler function
 * @returns {JSX.Element} Condition 1a button component
 */
function Condition_1a_Button({ onClick }) {
...
export default Condition_1a_Button;
