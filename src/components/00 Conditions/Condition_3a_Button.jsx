...
/**
 * Condition 3a Button Component
 * 
 * This component displays a button for condition 3a with a hover tooltip.
 * 
 * @param {Object} props - Component props
 * @param {Function} props.onClick - Click handler function
 * @returns {JSX.Element} Condition 3a button component
 */
function Condition_3a_Button({ onClick }) {
...
export default Condition_3a_Button;
