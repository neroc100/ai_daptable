...
/**
 * Condition 2a Button Component
 * 
 * This component displays a button for condition 2a with a hover tooltip.
 * 
 * @param {Object} props - Component props
 * @param {Function} props.onClick - Click handler function
 * @returns {JSX.Element} Condition 2a button component
 */
function Condition_2a_Button({ onClick }) {
...
export default Condition_2a_Button;
