 ...
 */
function Webpage_Content_Box({ isAnalysisDisplayed = false, highlightMalicious = false }) {
  ...
  const featureIcons = useMemo(() => {
    ...
    const features = ['Page Title', 'Content Type', 'Word Count'];
        ...
        <div className={`absolute flex flex-col space-y-3 ${isAnalysisDisplayed || highlightMalicious ? 'left-[44px]' : 'left-[24px]'} top-[106px] right-[24px]`}>
          ...
          <div className="flex items-start gap-[10px]">
            ...
            <div className="flex flex-col justify-start items-start flex-1 min-w-0">
              ...
              <div className="text-zinc-400 text-base font-normal font-['Inter'] leading-snug">
                {highlightMalicious ? (maliciousIcons[0] === 'thumbsDown' ? "Phishing" : "Legitimate") : "Suspicious"}
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-[10px]">
            ...
            <div className="flex flex-col justify-start items-start flex-1 min-w-0">
              ...
              <div className="text-zinc-400 text-base font-normal font-['Inter'] leading-snug">
                {highlightMalicious ? (maliciousIcons[1] === 'thumbsDown' ? "Malware" : "Safe") : "Malicious"}
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-[10px]">
            ...
            <div className="flex flex-col justify-start items-start flex-1 min-w-0">
              ...
              <div className="text-zinc-400 text-base font-normal font-['Inter'] leading-snug">
                {highlightMalicious ? (maliciousIcons[2] === 'thumbsDown' ? "8 malicious" : "2 safe") : "5 suspicious"}
              </div>
            </div>
          </div>
        </div>
