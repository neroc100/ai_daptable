...
/**
 * Encryption & HTTP Feature Display Box Component
 * 
 * This component displays encryption and HTTP features with title, icon, and values.
 * It includes a collapsible arrow indicator and structured layout for encryption analysis information.
 ...
 * @returns {JSX.Element} Encryption & HTTP feature display box component
 */
function Encryption_HTTP_Box({ isAnalysisDisplayed = false, highlightMalicious = false }) {
  ...
  const featureIcons = useMemo(() => {
    ...
    const features = ['SSL Certificate', 'HTTP Status', 'Security Headers'];
        ...
        <div className={`absolute flex flex-col space-y-3 ${isAnalysisDisplayed || highlightMalicious ? 'left-[44px]' : 'left-[24px]'} top-[106px] right-[24px]`}>
          ...
          <div className="flex items-start gap-[10px]">
            ...
            <div className="flex flex-col justify-start items-start flex-1 min-w-0">
              ...
              <div className="text-zinc-400 text-base font-normal font-['Inter'] leading-snug">
                {highlightMalicious ? (maliciousIcons[0] === 'thumbsDown' ? "Expired" : "Valid") : "Invalid"}
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-[10px]">
            ...
            <div className="flex flex-col justify-start items-start flex-1 min-w-0">
              ...
              <div className="text-zinc-400 text-base font-normal font-['Inter'] leading-snug">
                {highlightMalicious ? (maliciousIcons[1] === 'thumbsDown' ? "404 Error" : "200 OK") : "302 Redirect"}
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-[10px]">
            ...
            <div className="flex flex-col justify-start items-start flex-1 min-w-0">
              ...
              <div className="text-zinc-400 text-base font-normal font-['Inter'] leading-snug">
                {highlightMalicious ? (maliciousIcons[2] === 'thumbsDown' ? "None" : "Complete") : "Missing"}
              </div>
            </div>
          </div>
        </div>
