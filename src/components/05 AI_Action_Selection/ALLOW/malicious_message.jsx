...
function Malicious_Message({ onConfirm, onCancel, showReview = false, onReviewClick }) {
  return (
    <div className="w-[1250px] h-72 relative">
              <div className="w-[1250px] h-72 min-w-60 px-8 py-6 left-0 top-0 absolute rounded-lg border-4" style={{ backgroundColor: 'var(--eth-red-10)', borderColor: 'var(--eth-red-100)' }} />
