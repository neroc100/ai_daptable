...
/**
 * Success Message URL Allowed Component
 * 
 ...
 * @returns {JSX.Element} Success message modal component for URL allowed
 */
function Success_Message_URL_Allowed({ onOKClick }) {
  return (
    <div className="w-[760px] h-60 min-w-60 px-8 py-6 bg-white rounded-lg border-4 border-black">
