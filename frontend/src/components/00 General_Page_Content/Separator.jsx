...
function Separator() {
  return (
    ...
    <div className="w-full px-4 py-2 rounded-lg inline-flex flex-col justify-center items-center">
      {/* Thin horizontal line separator */}
      <div className="self-stretch h-px" style={{ backgroundColor: 'var(--eth-gray-80)' }} />
    </div>
  );
}
